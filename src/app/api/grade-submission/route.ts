...
// --- TIPO DE DATOS PARA LA CONSULTA A SUPABASE ---
...
export async function POST(req: NextRequest) {
  try {
    ...
    // Obtener la entrega y el solucionario con el tipado explícito
    ...
    if (!submission?.exams?.solution_file_url) throw new Error('El examen no tiene un solucionario subido o no se pudo encontrar.');
