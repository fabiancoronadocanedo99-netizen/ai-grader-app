...
export async function POST(request: NextRequest) {
  try {
    ...
    // Lógica global para los insights (se mantiene como resumen inicial)
    ...
    return NextResponse.json({
      ...
      // --- SECCIÓN ACTUALIZADA: Ahora incluye aiFeedback para el filtrado en cliente ---
      grades: allEvaluations.map((g: any) => ({
        ...
        aiFeedback: g.ai_feedback // <-- Crítico para el filtrado dinámico en el dashboard
      })),
